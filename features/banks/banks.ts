...
export const BANKS: Bank[] = [
  ...
  { code: 'istanbul-takas-ve-saklama-bankasi', name: 'İstanbul Takas ve Saklama Bankası (Takasbank)', eftCode: 132, aliases: ['Takasbank'] },
  ...
  { code: 'turkiye-ekonomi-bankasi', name: 'Türk Ekonomi Bankası (TEB)', eftCode: 32, aliases: ['TEB', 'Türkiye Ekonomi Bankası', 'CEPTETEB'] },
  ...
  { code: 'turkiye-garanti-bankasi', name: 'Türkiye Garanti Bankası (Garanti BBVA)', eftCode: 62, aliases: ['Garanti', 'Garanti BBVA', 'BBVA'] },
  { code: 'turkiye-halk-bankasi', name: 'Türkiye Halk Bankası (Halkbank)', eftCode: 12, aliases: ['Halkbank', 'Halk Bankası'] },
  ...
  { code: 'turkiye-sinai-kalkinma-bankasi', name: 'Türkiye Sınai Kalkınma Bankası (TSKB)', eftCode: 14, aliases: ['TSKB'] },
  ...
  { code: 'vakifbank', name: 'Türkiye Vakıflar Bankası (VakıfBank)', eftCode: 15, aliases: ['VakıfBank', 'Vakıflar Bankası'] },
