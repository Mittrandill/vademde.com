...
- Belgede bir IBAN geçiyorsa MUTLAKA fields dizisine fieldName="iban" olarak ekle ve normalizedValue'ya boşluksuz, büyük harfli hâlini yaz (ör. "TR330006100519786457841326"). Uygulama bankayı IBAN'ın içindeki banka kodundan kesin olarak belirliyor; banka adını doğru okusan bile IBAN'ı ayrıca yazmayı atlama. Birden fazla IBAN varsa belgeyi DÜZENLEYEN kurumun/hesap sahibinin IBAN'ını kullan.
